          ...
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
              <a class="navbar-brand nav-link">
                <img style="width:100%" alt="branding logo" 
                src="<?php echo base_url()?>assets/app-assets/images/logo/logo.png" 
                data-expand="<?php echo base_url()?>assets/app-assets/images/logo/logo.png" 
                class="brand-logo">
                </a>
            </li>
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" navigation-header">
            <span data-i18n="nav.category.support">GENERAL INFORMATION</span>
            <i data-toggle="tooltip" data-placement="right" data-original-title="General Information" class="icon-ellipsis icon-ellipsis"></i>
          </li>
          <li class=" nav-item"><a href="changelog.html"><i class="icon-android-person"></i>
          <span data-i18n="nav.changelog.main" class="menu-title"> Accounts</span></a>
          </li>
          <li class=" nav-item">
            <a href="#"><i class="icon-sitemap"></i>
              <span class="menu-title">Activities</span>
            </a>
            <ul class="menu-content">
              <li><a href="#" class="menu-item">Followers <span class="tag tag tag-pill tag-danger float-xs-right">0</span></a></li>
              <li><a href="#" class="menu-item">Following <span class="tag tag tag-pill tag-danger float-xs-right">0</span></a></li>
              <li><a href="#" class="menu-item">Friends <span class="tag tag tag-pill tag-danger float-xs-right">0</span></a></li>
              <li><a href="#" class="menu-item">Friend Requests <span class="tag tag tag-pill tag-danger float-xs-right">0</span></a></li>
            </ul>
          </li>
          ...
          <section id="description" class="card">
              ...
              <div class="card-body collapse in">
                  <div class="card-block">
                      <div class="card-text">
                          <p>2 Columns layout is the most common and popular layout, it has a navigation with content section. This layout use the common navbar and footer sections, however you can add customized header or footer on page level.</p>
                          <div class="alert alert-success alert-dismissible fade in mb-2" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                            Robust Admin Template default layout is 2 columns. If you do not define pageConfig block on page or template level, it will consider 2 columns by default.
                          </div>
                      </div>
                  </div>
              </div>
